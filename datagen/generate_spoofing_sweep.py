...
def generate_circle8_ini(
    ...
    lines: list[str] = [
        ...
        "",
        f"# Generated sweep {tag} — circle {n}x1 + spoofer, seed-driven geometry",
        "",
        f"[Config {tag}_Base]",
        f"description = \"circle8 sweep base (extended by Aware / TrustRid)\"",
        (
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Generate spoofing sweep scenarios")
    parser.add_argument(
