...
def summarize_sweep_directory(
    ...
    for (h, tag_base) in sorted(pairs.keys()):
        ...
        rows.append({
            ...
            "localization_mlat_raw_mae_m_aware": sa.get("localization_mlat_raw_mae_m_final"),
            "localization_mlat_raw_mae_m_aware_instant_detect": sai.get("localization_mlat_raw_mae_m_final"),
            "localization_mlat_raw_rmse_m_aware": sa.get("localization_mlat_raw_rmse_m_final"),
            "localization_mlat_raw_rmse_m_aware_instant_detect": sai.get("localization_mlat_raw_rmse_m_final"),
            "localization_mlat_raw_samples_aware": sa.get("localization_mlat_raw_samples_final"),
            "localization_mlat_raw_samples_aware_instant_detect": sai.get("localization_mlat_raw_samples_final"),
